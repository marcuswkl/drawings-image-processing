...
img_ori = cv2.imread("04.png", cv2.IMREAD_GRAYSCALE)
# img_ori = cv2.imread("05.png", cv2.IMREAD_GRAYSCALE)
...
img_ori = cv2.imread("06.png", cv2.IMREAD_GRAYSCALE)
# img_ori = cv2.imread("07.png", cv2.IMREAD_GRAYSCALE)
